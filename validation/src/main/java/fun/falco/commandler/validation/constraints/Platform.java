...
import fun.falco.commandler.validation.validators.PlatformValidator;
...
public @interface Platform {
    ...
    String message() default "{fun.falco.commandler.validation.constraints.Platform.message}";
